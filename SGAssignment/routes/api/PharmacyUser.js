...
// Load User model
const User = require("../../models/PharmacyUser");

//Post Router api/users/register
Router.post("/registerPharmacy", (req, res) => {
  //Form Validation
  ...
  User.findOne({
    ...
    if (user) {
      ...
      const newUser = new User({
        //getting email,passowrd, and name entere by the user.
        name: req.body.name,
        email: req.body.email,
...
Router.post("/loginPharmacy", (req, res) => {
  //Login Validation
